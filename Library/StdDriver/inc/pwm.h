...
#define PWM_CH0_MASK                        (1UL)    /*!< PWM channel 0 mask  \hideinitializer */
#define PWM_CH1_MASK                        (2UL)    /*!< PWM channel 1 mask  \hideinitializer */
#define PWM_CH2_MASK                        (4UL)    /*!< PWM channel 2 mask  \hideinitializer */
#define PWM_CH3_MASK                        (8UL)    /*!< PWM channel 3 mask  \hideinitializer */
